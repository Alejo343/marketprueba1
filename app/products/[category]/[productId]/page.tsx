      ...
      <div className="min-h-screen bg-[#080808]" style={{ fontFamily: "var(--font-inter)" }}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          ...
          <nav className="flex items-center gap-2 text-xs text-[#555] mb-8" aria-label="Breadcrumb">
            ...
            <ChevronIcon />
            <Link href={`/products/${categorySlug}`} className="hover:text-[#C9A84C] transition-colors duration-200 capitalize">
          ...
          {product.description && (
            <div className="max-w-2xl">
              <h2 className="text-lg font-bold text-[#F5F0E8] mb-4" style={{ fontFamily: "var(--font-playfair)" }}>
                Descripción
              </h2>
